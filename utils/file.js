...
/**
 * The fileUtils object contains methods to
 * validate and save files to the database and disk.
 */

const fileUtils = {
  /**
   * Will validate the body of a request
  ...
  /**
   * the getFilesOfParentId method should
  ...
  /**
   * This method will update a file in the database
  ...
  /**
   * This makes a file public or private depending on the
   * setPublish value given to it in the request object and
   * the file id given in the request object as well as the
   * user id obtained from the request object as well.
   * @request {request_object} express request obj
